...
void LitColumnsApp::UpdateMainPassCB(const GameTimer& gt)
{
	...
	//mMainPassCB.AmbientLight = { 0.1f, 0.0f, 0.0f, 1.0f };
	...
	mMainPassCB.Lights[0].Position = { 0, 0, 0 };
	mMainPassCB.Lights[0].Strength = {0.4f , 0.1f , 0.1f };
	mMainPassCB.Lights[0].Direction = { 0, 1, 0 };


	mMainPassCB.Lights[11].Strength = { 0.0f , 1.0f , 0.1f };
	XMVECTOR t = {0 , 0 , 0};
	XMVECTOR x = { 0, 10 , 0 };
	XMStoreFloat3(&mMainPassCB.Lights[11].Position, x);
	XMVECTOR a = XMVector3Normalize(t - x);
	XMStoreFloat3(&mMainPassCB.Lights[11].Direction, a);


	//XMVECTOR lightDir = -MathHelper::SphericalToCartesian(1.0f, mSunTheta, mSunPhi);
	//XMStoreFloat3(&mMainPassCB.Lights[0].Direction, lightDir);
	//mMainPassCB.Lights[0].Strength = {0.2f, 0.1f , 0.1f}; 
...
void LitColumnsApp::BuildRenderItems()
{
	...
	for(int i = 0; i < 5; ++i)
	{
		...
		mMainPassCB.Lights[i+1].Position = { -5.0f, 5.0f, -10.0f + i * 5.0f };
		mMainPassCB.Lights[i+1].Strength = { 0.3f , 0.2f , 0.05f };

		mMainPassCB.Lights[i+6].Position = { +5.0f, 5.0f, -10.0f + i * 5.0f };
		mMainPassCB.Lights[i+6].Strength = { 0.3f , 0.2f , 0.05f };
